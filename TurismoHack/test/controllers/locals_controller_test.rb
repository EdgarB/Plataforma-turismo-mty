...
class LocalsControllerTest < ActionController::TestCase
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post :create, local: { apertura: @local.apertura, clausura: @local.clausura, descripcion: @local.descripcion, nombre: @local.nombre }
    end
  ...
  test "should update local" do
    patch :update, id: @local, local: { apertura: @local.apertura, clausura: @local.clausura, descripcion: @local.descripcion, nombre: @local.nombre }
    assert_redirected_to local_path(assigns(:local))
  end
